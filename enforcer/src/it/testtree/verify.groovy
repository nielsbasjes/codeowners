...
assert text.contains("| \${baseDir}/docs/CODEOWNERS    | [@documentation]    |")
assert text.contains("| \${baseDir}/dir1/              | [@integrationtest]  |")
assert text.contains("| \${baseDir}/dir1/.gitignore    | [@dir1project]      |")
assert text.contains("| \${baseDir}/dir1/dir1.md       | [@dir1project]      |")
assert text.contains("| \${baseDir}/dir2/              | [@integrationtest]  |")
assert text.contains("| \${baseDir}/dir2/dir2.txt      | [@txt]              |")
assert text.contains("| \${baseDir}/dir2/file2.log     | [@log]              |")
assert text.contains("| \${baseDir}/dir3/              | [@integrationtest]  |")
assert text.contains("| \${baseDir}/dir3/.gitignore    | [@dir3project]      |")
assert text.contains("| \${baseDir}/dir3/dir3.txt      | [@dir3project]      |")
assert text.contains("| \${baseDir}/dir3/file3.log     | [@dir3project]      |")
